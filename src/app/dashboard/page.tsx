    ...
    <DashboardLayout>
      <div className='grid gap-6'>
        ...
        {subscription.tier === 'free' && (
          <div className='p-4 border rounded-lg border-primary/30 bg-primary/10'>
            <div className='flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between'>
              <p className='text-sm'>
                <strong>You're on the Free plan.</strong> Upgrade to Pro for
                advanced features.
              </p>
              <a
                href='/dashboard/billing'
                className='inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition-colors rounded-md shadow bg-primary text-primary-foreground hover:bg-primary/90'
              >
                Upgrade Plan
              </a>
            </div>
