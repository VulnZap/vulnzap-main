  ...
  return (
    <footer className='border-t bg-background' aria-labelledby='footer-heading'>
      ...
      <div className='px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32'>
        <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
          <div className='space-y-8'>
            <Link href='/' className='text-xl font-bold'>
              <span className='text-primary'>Vuln</span>Zap
            </Link>
            <p className='text-sm leading-6 text-muted-foreground'>
              Secure your software supply chain with comprehensive vulnerability
              scanning across multiple ecosystems.
            </p>
        ...
        <div className='pt-8 mt-16 border-t sm:mt-20 lg:mt-24'>
          <p className='text-xs leading-5 text-muted-foreground'>
            &copy; {new Date().getFullYear()} VulnZap. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
